        ...
        <>
            <div className='bg-slate-800 p-10 text-white rounded-lg flex flex-wrap ' style={{
                ...
                <div className='flex flex-col gap-4'>
                    <div>
                        <h1>CONTACT US</h1>
                        <p className='text-2xl footerlim2:text-4xl'> +91 07 3337 7801</p>
                        <p className='italic footerlim2:text-4xl'>info@creativeenterprise.com</p>
                    </div>

                    <div className='font-thin'>
                        <p>Creative Industries Enterprise Center</p>
